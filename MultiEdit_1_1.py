...
#Create a dictionary to put the mesh name, connected with the object name:
mesh_name = {}
...
class MultiEdit_Enter(bpy.types.Operator):
    ...
    def Duplicate_Object(self, scene, name, old_object):
        ...
        #Copy mesh name
        mesh_name[old_object.name] = old_object.data.name
...
class MultiEdit_Exit(bpy.types.Operator):
    ...
    def Fix_Objects(self, active_object, name, vgroup_index):
        ...
        for object in bpy.context.selected_objects:
            ...
            #Fix mesh name
            if(object.name in mesh_name):
                object.data.name = mesh_name[object.name]
